...
public interface QuestioningAccreditationRepository extends JpaRepository<QuestioningAccreditation, Long> {
    ...
    static final String QUERY_SOURCE_YEAR_PERIOD = FIND_METADATA_COPY + " where mc.id_source = ?1 and mc.\"year\" = ?2 and mc.\"period\" = ?3 ";

    static final String QUERY_SOURCE = FIND_METADATA_COPY + " where mc.id_source = ?1 ";

    static final String QUERY_YEAR = FIND_METADATA_COPY + " where mc.\"year\" = ?1  ";

    static final String QUERY_PERIOD = FIND_METADATA_COPY + " where mc.\"period\" = ?1 ";
